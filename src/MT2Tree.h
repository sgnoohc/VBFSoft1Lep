...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           ngenStat23;
   Float_t         genStat23_pt[20];   //[ngenStat23]
   Float_t         genStat23_eta[20];   //[ngenStat23]
   Float_t         genStat23_phi[20];   //[ngenStat23]
   Float_t         genStat23_mass[20];   //[ngenStat23]
   Int_t           genStat23_pdgId[20];   //[ngenStat23]
   Int_t           genStat23_status[20];   //[ngenStat23]
   Float_t         genStat23_charge[20];   //[ngenStat23]
   Int_t           genStat23_sourceId[20];   //[ngenStat23]
   Int_t           ngenGamma;
