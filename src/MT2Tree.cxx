...
void MT2Tree::Init(TTree *tree)
{
   ...
   fChain ->SetBranchStatus("evt_scale1fb"                                   , 0); fChain ->SetBranchAddress("evt_scale1fb"                                   , &evt_scale1fb                                   , &b_evt_scale1fb);
   ...
   fChain ->SetBranchStatus("nBJet25"                                        , 0); fChain ->SetBranchAddress("nBJet25"                                        , &nBJet25                                        , &b_nBJet25);
   ...
   fChain ->SetBranchStatus("ht"                                             , 0); fChain ->SetBranchAddress("ht"                                             , &ht                                             , &b_ht);
   ...
   fChain ->SetBranchStatus("met_pt"                                         , 0); fChain ->SetBranchAddress("met_pt"                                         , &met_pt                                         , &b_met_pt);
   fChain ->SetBranchStatus("met_phi"                                        , 0); fChain ->SetBranchAddress("met_phi"                                        , &met_phi                                        , &b_met_phi);
   ...
   fChain ->SetBranchStatus("njet"                                           , 0); fChain ->SetBranchAddress("njet"                                           , &njet                                           , &b_njet);
   fChain ->SetBranchStatus("jet_pt"                                         , 0); fChain ->SetBranchAddress("jet_pt"                                         , jet_pt                                          , &b_jet_pt);
   fChain ->SetBranchStatus("jet_eta"                                        , 0); fChain ->SetBranchAddress("jet_eta"                                        , jet_eta                                         , &b_jet_eta);
   fChain ->SetBranchStatus("jet_phi"                                        , 0); fChain ->SetBranchAddress("jet_phi"                                        , jet_phi                                         , &b_jet_phi);
   fChain ->SetBranchStatus("jet_mass"                                       , 0); fChain ->SetBranchAddress("jet_mass"                                       , jet_mass                                        , &b_jet_mass);
   fChain ->SetBranchStatus("jet_btagCSV"                                    , 0); fChain ->SetBranchAddress("jet_btagCSV"                                    , jet_btagCSV                                     , &b_jet_btagCSV);
   fChain ->SetBranchStatus("jet_rawPt"                                      , 0); fChain ->SetBranchAddress("jet_rawPt"                                      , jet_rawPt                                       , &b_jet_rawPt);
   fChain ->SetBranchStatus("jet_mcPt"                                       , 0); fChain ->SetBranchAddress("jet_mcPt"                                       , jet_mcPt                                        , &b_jet_mcPt);
   fChain ->SetBranchStatus("jet_chf"                                        , 0); fChain ->SetBranchAddress("jet_chf"                                        , jet_chf                                         , &b_jet_chf);
   fChain ->SetBranchStatus("jet_FSveto"                                     , 0); fChain ->SetBranchAddress("jet_FSveto"                                     , jet_FSveto                                      , &b_jet_FSveto);
   fChain ->SetBranchStatus("jet_mcFlavour"                                  , 0); fChain ->SetBranchAddress("jet_mcFlavour"                                  , jet_mcFlavour                                   , &b_jet_mcFlavour);
   fChain ->SetBranchStatus("jet_hadronFlavour"                              , 0); fChain ->SetBranchAddress("jet_hadronFlavour"                              , jet_hadronFlavour                               , &b_jet_hadronFlavour);
   fChain ->SetBranchStatus("jet_qgl"                                        , 0); fChain ->SetBranchAddress("jet_qgl"                                        , jet_qgl                                         , &b_jet_qgl);
   fChain ->SetBranchStatus("jet_area"                                       , 0); fChain ->SetBranchAddress("jet_area"                                       , jet_area                                        , &b_jet_area);
   fChain ->SetBranchStatus("jet_id"                                         , 0); fChain ->SetBranchAddress("jet_id"                                         , jet_id                                          , &b_jet_id);
   fChain ->SetBranchStatus("jet_puId"                                       , 0); fChain ->SetBranchAddress("jet_puId"                                       , jet_puId                                        , &b_jet_puId);
