...
// Fri Mar 24 17:12:48 2017 by ROOT version 6.06/01
// from TTree mt2/A Baby Ntuple
// found on file: softLep-v3_V00-01-10_25ns_miniaodv2/ttsl_mg_lo_top.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         lep_relIsoAn04[5];   //[nlep]
   Int_t           lep_mcMatchId[5];   //[nlep]
   Int_t           lep_lostHits[5];   //[nlep]
   Int_t           lep_convVeto[5];   //[nlep]
   Int_t           lep_tightCharge[5];   //[nlep]
   Float_t         lep_mva[5];   //[nlep]
   Float_t         lep_ptRatio[5];   //[nlep]
   Float_t         lep_ptRel[5];   //[nlep]
   Int_t           lep_tightIdNoIso[5];   //[nlep]
   ...
   Int_t           genTau_sourceId[1];   //[ngenTau]
   Int_t           genTau_decayMode[1];   //[ngenTau]
   Float_t         genTau_leadTrackPt[1];   //[ngenTau]
   Int_t           genTau_neutralDaughters[1];   //[ngenTau]
